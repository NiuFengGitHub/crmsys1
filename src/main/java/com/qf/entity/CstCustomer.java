...
public class CstCustomer {
    ...
    public String getCustChieftrain() {
        return custChieftrain;
    }

    public void setCustChieftrain(String custChieftrain) {
        this.custChieftrain = custChieftrain == null ? null : custChieftrain.trim();
    }
